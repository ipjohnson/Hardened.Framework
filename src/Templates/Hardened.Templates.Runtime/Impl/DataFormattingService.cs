...
namespace Hardened.Templates.Runtime.Impl
{
    public class DataFormattingService : IDataFormattingService
    {
        ...
        public object FormatData(ITemplateExecutionContext templateExecutionContext, string propertyName, object? data, string? formatString = null)
        {
            if (data == null)
            {
                return "";
        ...
        private object GetFormattedStringData(ITemplateExecutionContext templateExecutionContext, string propertyName, object data,
            string? formatString)
        {
        ...
        private static object DefaultFormat(ITemplateExecutionContext executionContext, string propertyName, object? data, string? formatString)
        {
            if (data == null)
            {
                return "";

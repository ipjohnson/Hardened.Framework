...
public class TemplateImplementationGenerator {
    ...
    public void GenerateImplementation(ClassDefinition classDefinition, string templateExtension,
        IList<TemplateActionNode> templateNodes) {
        ...
        executeMethodDefinition.AddCode(
            "var executionContext = new {arg1}({arg2}, serviceProvider, requestValue, _services, _templateExecutionService, _stringEscapeService, writer, parentTemplateExecutionContext, requestExecutionContext);",
            KnownTypes.Templates.TemplateExecutionContext, templateExtension);
    ...
    private MethodDefinition InitializeMethodDefinition(ClassDefinition classDefinition, string templateExtension) {
        ...
        initializeMethodDefinition.AddCode(
            "_stringEscapeService = _services.StringEscapeServiceProvider.GetEscapeService({arg1});",
            templateExtension);
    ...
    private int ProcessModelUsingAndInjectStatements(
        ClassDefinition classDefinition, MethodDefinition methodDefinition,

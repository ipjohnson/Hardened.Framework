...
///
/// <para>
/// This project exists so the <c>templates</c> workstream can add test files without editing the
...
public class ScaffoldTests {
    ...
    public void TheAssemblyUnderTestIsReferencedAndLoadable() {
        var assembly = Assembly.Load("Hardened.Templates.SourceGenerator");

...
/// <c>Hardened.Web.SourceGenerator.Tests</c>, against <c>Hardened.Web.SourceGenerator</c>'s copy of
/// this code - and every generator here compiles <c>Hardened.SourceGenerator</c>'s sources in rather
/// than referencing the assembly, so that run says nothing about this one.
/// </para>
/// <para>

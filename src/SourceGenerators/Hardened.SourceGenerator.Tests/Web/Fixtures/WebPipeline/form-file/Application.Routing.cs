...
;
        ...
        private static void RoutingTableDI(IServiceCollection serviceCollection)
        {
            ...
            >();
            serviceCollection.AddTransient<UploadController>();
        ...
        private class RoutingTable : IWebExecutionRequestHandlerProvider
        {
            ...
            private RequestHandlerInfo? _infoUploadController_Upload_1556;
...
;
            ...
            public RequestHandlerInfo? TestPath_Slashupload(ReadOnlySpan<char> charSpan, int index, string methodString, ref PathTokenCollection pathTokens)
            {
                RequestHandlerInfo? handlerInfo = null;
                if ((charSpan.Length >= index + 7) && charSpan.Slice(index, 7).SequenceEqual("/upload"))
                {
                    index += 7;

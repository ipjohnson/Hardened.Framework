...
{
    public partial class TicketController_Remove_329 : global::Hardened.Requests.Runtime.Execution.BaseExecutionHandler<global::TestApp.TicketController>
    {
...
;
        private readonly static global::Hardened.Requests.Runtime.Execution.ExecutionRequestHandlerInfo _handlerInfo =         new ExecutionRequestHandlerInfo("/tickets/{id}", "DELETE", typeof(TicketController), "Remove", _parameterInfo)
;

        public TicketController_Remove_329(global::System.IServiceProvider serviceProvider, string? routePath = null)
        ...
        {
            await controller.Remove(parameters.id);
        }

...
{
    public partial class TicketController_Replace_329 : global::Hardened.Requests.Runtime.Execution.BaseExecutionHandler<global::TestApp.TicketController>
    {
...
;
        private readonly static global::Hardened.Requests.Runtime.Execution.ExecutionRequestHandlerInfo _handlerInfo =         new ExecutionRequestHandlerInfo("/tickets/{id}", "PUT", typeof(TicketController), "Replace", _parameterInfo)
;

        public TicketController_Replace_329(global::System.IServiceProvider serviceProvider, string? routePath = null)
             : base(global::Hardened.Requests.Runtime.Execution.ExecutionHelper.AsyncStandardFilterWithParameters<
            global::TestApp.TicketController,
            Parameters
        >(
            serviceProvider,
        ...
        private static async global::System.Threading.Tasks.Task InvokeMethod(global::Hardened.Requests.Abstract.Execution.IExecutionContext context, global::TestApp.TicketController controller, Parameters parameters)
        {
            context.Response.ResponseValue = await controller.Replace(parameters.id);
        }

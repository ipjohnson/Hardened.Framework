...
public class DefaultErrorBodyTests
{
    ...
    public void ASmithyErrorShapeFillsItsRequiredMessage()
    {
        var schemas = new[]
        {
            Schema("TodoNotFound", isErrorShape: true, String("message", required: true)),
        };
    ...
    public void AnOrdinaryPayloadWithARequiredMessageStillGetsNoInstance()
    {
        var schemas = new[]
        {
            Schema("ChatPost", isErrorShape: false, String("message", required: true)),
        };
    ...
    public void AnErrorShapeFillsAMessageAndDefaultsTheRest()
    {
        ...
        Assert.Equal(
            ["\"Not Found\"", "default"],
            DefaultErrorBody.Arguments(schemas, "PetMissing", 404)
        );
    }
    ...
    public void ThePhraseIsTheStatusItIsFilledFor()
    {
        var schemas = new[]
        {
            Schema("TitleTaken", isErrorShape: true, String("message", required: true)),
        };
    ...
    public void ADeclaredDefaultBeatsTheReasonPhrase()
    {
        ...
        Assert.Equal(
            ["\"no such todo\""],
            DefaultErrorBody.Arguments(schemas, "TodoNotFound", 404)
        );
    }
    ...
    public void AProblemFillsItsSpecifiedMembersAndLeavesDetailEmpty()
    {
        ...
        Assert.Equal(
            [
                "global::Hardened.Web.Runtime.Responses.ProblemTypes.NotFound",
                "\"Not Found\"",
                "404",
                "default",
            ],

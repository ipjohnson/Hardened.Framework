...
public class TemplateBaseGeneratorTests
{
    ...
    {
        var source = Generate(Application("Application", "FluidTemplate"))
            .SourceContaining("FluidTemplate");
    ...
    {
        var source = Generate(Application("Storefront", "FluidTemplate"))
            .SourceContaining("FluidTemplate");
    ...
    public void TwoMarkersProduceTwoBases()
    {
        ...
        Assert.Contains(
            "class ApplicationFluidTemplate<TModel>",
            result.SourceContaining("FluidTemplate")
        );
        Assert.Contains(
            "class ApplicationCsvTemplate<TModel>",
            result.SourceContaining("CsvTemplate")
        );
    ...
    public void AMarkerWithNoTemplateBaseIsIgnored()
    {
        ...
        Assert.DoesNotContain(
            ...
            key => key.Contains("SomeOtherFeature")
        );
    }

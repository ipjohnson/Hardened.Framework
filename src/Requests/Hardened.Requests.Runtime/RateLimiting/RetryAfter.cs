...
/// <remarks>
/// <para>
/// Here rather than beside the statuses that write it, because those left for
/// <c>Hardened.Web.Runtime</c> and these two callers did not: <c>RateLimitExceededException</c> and
/// <c>ExceptionToModelConverter</c> are pipeline concerns and a rate limit is not an HTTP idea.
/// A web package can reach down to this; the reverse would not compile.
/// </para>
/// <para>

...
public class ResponseHeaderConfiguration : IResponseHeaderConfiguration
{
    ...
    IReadOnlyList<KeyValuePair<string, StringValues>> IResponseHeaderConfiguration.CommonHeaders =>
        CommonHeaders;

    IReadOnlyList<Action<IExecutionContext>> IResponseHeaderConfiguration.HeaderActions =>
        HeaderActions;
}

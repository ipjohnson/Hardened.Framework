...
/// <summary>
/// A 502 carrying a body the caller supplies.
/// </summary>
/// <remarks>
/// <para>
/// The generic form of <see cref="BadGateway"/>, for a caller who already has a payload type and does
...
/// </para>
/// <para>
/// This is what a specification-first build binds a declared 502 with a body to, so a declared
...
/// <c>BadGateway, BadGateway</c> would be.
/// </para>
/// </remarks>
[HttpStatus(502)]

...
/// <summary>
/// A 500 carrying a body the caller supplies.
/// </summary>
/// <remarks>
/// <para>
/// The generic form of <see cref="InternalServerError"/>, for a caller who already has a payload type and does
...
/// </para>
/// <para>
/// This is what a specification-first build binds a declared 500 with a body to, so a declared
...
/// <c>InternalServerError, InternalServerError</c> would be.
/// </para>
/// </remarks>
[HttpStatus(500)]

...
public class BlobsAdapterTests
{
    ...
    private static readonly BlobClient Blob = new(
        new Uri("https://devstoreaccount1.blob.core.windows.net/uploads/reports/my%20report.pdf")
    );
    ...
    public void TheBodyIsTheNotificationWithTheNameDecoded()
    {
        ...
        Assert.Equal(
            BlobsAdapter.BlobCreated,
            body.RootElement.GetProperty("eventName").GetString()
        );

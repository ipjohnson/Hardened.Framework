// Copied 2026-08-11 from Hardened.Framework/src/SourceGenerators/Hardened.SourceGeneration.Testing/TestAnalyzerConfigOptions.cs.
//
// Hardened.Amz is a separate repository and Hardened.SourceGeneration.Testing is not published to
// the feed, so there is nothing to reference. TESTING-PLAN.md 0.1 sanctions the duplicate: "the two
// repositories keep separate copies deliberately - a fix worth having in one is usually worth
// porting to the other." Only the namespace differs. Keep the two in step by hand.
using Microsoft.CodeAnalysis;
using Microsoft.CodeAnalysis.Diagnostics;
using Microsoft.CodeAnalysis.Text;

namespace Hardened.Amz.SourceGeneration.Testing;

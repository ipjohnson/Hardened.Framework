...
public class EmbeddedMetricLoggerProvider : IMetricLoggerProvider {
    ...
    public EmbeddedMetricLoggerProvider(IDimensionSetProvider dimensionSetProvider, ILoggerFactory loggerFactory,
        ILogger<EmbeddedMetricLoggerProvider> logger) {

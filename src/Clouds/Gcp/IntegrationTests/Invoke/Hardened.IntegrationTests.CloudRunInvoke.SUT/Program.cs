...
// The invoke fixture, hosted as a deployed Cloud Run service is: Kestrel on the port Cloud Run
// names, invoked by a POST to /_triggers/invoke/{operation}.
...
new CloudRunInvokeApp().PopulateServiceCollection(services);

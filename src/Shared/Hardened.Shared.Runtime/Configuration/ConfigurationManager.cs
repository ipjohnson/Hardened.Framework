...
public class ConfigurationManager : IConfigurationManager
{
    ...
    public ConfigurationManager(
        ...
        IEnumerable<IConfigurationPackage> configurationPackages
    )
    {
        ...
        {
            foreach (
                var valueProvider in configurationPackage.ConfigurationValueProviders(environment)
            )
            {
    ...
    private T CreateConfigurationValue<T>(IConfigurationValueProvider valueProvider)
        where T : class
    {

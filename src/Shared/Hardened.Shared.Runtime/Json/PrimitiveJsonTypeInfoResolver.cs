...
public sealed class PrimitiveJsonTypeInfoResolver : IJsonTypeInfoResolver
{
    ...
    /// </para>
    /// </remarks>
    private static JsonTypeInfo<T> Value<T>(
        JsonSerializerOptions options,
        JsonConverter<T> builtIn
    ) => JsonMetadataServices.CreateValueInfo<T>(options, Converter(options, builtIn));

    private static JsonConverter<T> Converter<T>(
        JsonSerializerOptions options,
        JsonConverter<T> builtIn
    )
    {
        ...
        foreach (var converter in options.Converters)
        {
            ...
            if (
                converter is JsonConverterFactory factory
    ...
    public JsonTypeInfo? GetTypeInfo(Type type, JsonSerializerOptions options)
    {
        ...
        if (type == typeof(string))
            return Value(options, JsonMetadataServices.StringConverter);
        if (type == typeof(bool))
            return Value(options, JsonMetadataServices.BooleanConverter);
        if (type == typeof(int))
            return Value(options, JsonMetadataServices.Int32Converter);
        if (type == typeof(long))
            return Value(options, JsonMetadataServices.Int64Converter);
        if (type == typeof(double))
            return Value(options, JsonMetadataServices.DoubleConverter);
        if (type == typeof(DateTimeOffset))
            return Value(options, JsonMetadataServices.DateTimeOffsetConverter);
        if (type == typeof(JsonElement))
            return Value(options, JsonMetadataServices.JsonElementConverter);
        if (type == typeof(DateOnly))
            return Value(options, JsonMetadataServices.DateOnlyConverter);
        if (type == typeof(float))
            return Value(options, JsonMetadataServices.SingleConverter);
        if (type == typeof(uint))
            return Value(options, JsonMetadataServices.UInt32Converter);
        if (type == typeof(byte[]))
            return Value(options, JsonMetadataServices.ByteArrayConverter);
        if (type == typeof(decimal))
            return Value(options, JsonMetadataServices.DecimalConverter);
        if (type == typeof(Guid))
            return Value(options, JsonMetadataServices.GuidConverter);
        if (type == typeof(DateTime))
            return Value(options, JsonMetadataServices.DateTimeConverter);
        if (type == typeof(TimeSpan))
            return Value(options, JsonMetadataServices.TimeSpanConverter);
        if (type == typeof(TimeOnly))
            return Value(options, JsonMetadataServices.TimeOnlyConverter);
        if (type == typeof(byte))
            return Value(options, JsonMetadataServices.ByteConverter);
        if (type == typeof(sbyte))
            return Value(options, JsonMetadataServices.SByteConverter);
        if (type == typeof(short))
            return Value(options, JsonMetadataServices.Int16Converter);
        if (type == typeof(ushort))
            return Value(options, JsonMetadataServices.UInt16Converter);
        if (type == typeof(ulong))
            return Value(options, JsonMetadataServices.UInt64Converter);
        if (type == typeof(char))
            return Value(options, JsonMetadataServices.CharConverter);
        if (type == typeof(Uri))
            return Value(options, JsonMetadataServices.UriConverter);
        if (type == typeof(Version))
            return Value(options, JsonMetadataServices.VersionConverter);
        ...
        if (type == typeof(bool?))
            return Nullable<bool>(options);
        if (type == typeof(int?))
            return Nullable<int>(options);
        if (type == typeof(long?))
            return Nullable<long>(options);
        if (type == typeof(double?))
            return Nullable<double>(options);
        if (type == typeof(DateTimeOffset?))
            return Nullable<DateTimeOffset>(options);
        if (type == typeof(JsonElement?))
            return Nullable<JsonElement>(options);
        if (type == typeof(DateOnly?))
            return Nullable<DateOnly>(options);
        if (type == typeof(float?))
            return Nullable<float>(options);
        if (type == typeof(uint?))
            return Nullable<uint>(options);
        if (type == typeof(decimal?))
            return Nullable<decimal>(options);
        if (type == typeof(Guid?))
            return Nullable<Guid>(options);
        if (type == typeof(DateTime?))
            return Nullable<DateTime>(options);
        if (type == typeof(TimeSpan?))
            return Nullable<TimeSpan>(options);
        if (type == typeof(TimeOnly?))
            return Nullable<TimeOnly>(options);
        if (type == typeof(byte?))
            return Nullable<byte>(options);
        if (type == typeof(sbyte?))
            return Nullable<sbyte>(options);
        if (type == typeof(short?))
            return Nullable<short>(options);
        if (type == typeof(ushort?))
            return Nullable<ushort>(options);
        if (type == typeof(ulong?))
            return Nullable<ulong>(options);
        if (type == typeof(char?))
            return Nullable<char>(options);

        return null;
    }

    private static JsonTypeInfo<T?> Nullable<T>(JsonSerializerOptions options)
        where T : struct =>
        JsonMetadataServices.CreateValueInfo<T?>(
            options,
            JsonMetadataServices.GetNullableConverter<T>(options)
        );
}

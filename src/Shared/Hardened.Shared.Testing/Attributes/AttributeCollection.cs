...
public class AttributeCollection : IEnumerable<object>
{
    public AttributeCollection(
        IReadOnlyList<object> methodAttributes,
        IReadOnlyList<object> classAttributes,
    ...
    public static AttributeCollection FromMethodInfo(MethodInfo method)
    {
        ...
        var classAttributes =
            method.DeclaringType?.GetCustomAttributes(true) ?? Array.Empty<object>();
        var assemblyAttributes =
            method.DeclaringType?.Assembly.GetCustomAttributes(true) ?? Array.Empty<object>();
            ...
            list.Sort(
                (x, y) =>
                    Comparer<int>.Default.Compare(
                        ((IHardenedOrderedAttribute)x).Order,
